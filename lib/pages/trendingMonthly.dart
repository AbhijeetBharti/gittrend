...
class TrendingMonthly extends StatefulWidget {
  @override
  _TrendingMonthlyState createState() => _TrendingMonthlyState();
}

class _TrendingMonthlyState extends State<TrendingMonthly> {
  List data;
  List fetchData;
