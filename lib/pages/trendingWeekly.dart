...
class TrendingWeekly extends StatefulWidget {
  @override
  _TrendingWeeklyState createState() => _TrendingWeeklyState();
}

class _TrendingWeeklyState extends State<TrendingWeekly> {
  List data;
  List fetchData;

  Future getData() async {
    http.Response response = await http.get(
        "https://github-trending-api.now.sh/repositories?language=&since=weekly");
